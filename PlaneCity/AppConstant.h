...
#define DELEGATOR_CALL                          (AppDelegate*)[[UIApplication sharedApplication]delegate]
...
#define		PF_USER_FBLOGGED					@"fb_login"                  //	String
#define		PF_USER_LILOGGED					@"li_login"                  //	String
#define		PF_USER_EMLOGGED					@"em_login"                  //	String
#define		PF_USER_STATUS					@"status"                     //	String
#define		PF_USER_ADDRESS					@"address"                   //	String
#define		PF_USER_FOOD                        @"food"                        //	String
#define		PF_USER_HOBBY                       @"hobby"                       //	String
#define		PF_USER_VISITPLACE                  @"visitplace"                //	String
//-----------------------------------------------------------------------
